...
test(are_neighbors08, [nondet])   :- are_neighbors([[1, 2, 3], [4, 5, 6]], 2, 5).
test(are_neighbors09, [nondet])   :- are_neighbors([[1, 2, 3], [4, 5, 6]], 3, 6).
test(are_neighbors10, [nondet])   :- are_neighbors([[1, 2], [3, 4], [5, 6]], 4, 6).
test(are_neighbors11, [nondet])   :- are_neighbors([[1, 2], [3, 4], [5, 6]], 2, 4).
test(are_neighbors12, [fail])   :- are_neighbors([[1, 2], [3, 4], [5, 6]], 3, 6).
